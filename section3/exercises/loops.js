...
// 1 is added to zero so that i is now 1, one is printed, one is less than zero, 1 is added
// to i which is now 2. 2 is printed, two is less than 3. 1 is added to i which makes i 3.
// 3 is not less than 3 so nothing prints.
