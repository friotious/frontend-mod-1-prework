...
// How did you decide to use the data type you did for each of the three variables above?
  // Explain.
// firstName: my name consists of letters which are a string data types
// isHungry: a yes or no question is a true/false type answer so this is a Boolean data type
// numberOfPets: answer is a number so number data type
